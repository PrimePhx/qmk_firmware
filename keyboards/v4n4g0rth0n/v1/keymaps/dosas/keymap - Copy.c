...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT(
      ...
      KC_ESC,  KC_Q,  KC_W, KC_F, KC_P, KC_B,      KC_J, KC_L, KC_U,    KC_Y,   KC_;, KC_BSPC,
      KC_TAB,  GuiA,  AltR, CtlS, SftT, KC_G,      KC_M, SftN, CtlE,    AltI,   GuiO, KC_QUOT,
      KC_LSPO, KC_Z,  KC_X, KC_C, KC_D, KC_V,      KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_HYPR,
      KC_LCTL,KC_LGUI,KC_LALT,LT(_NAV,KC_SPC),     LT(_SYM,KC_BSPC),  LT(_NUM,KC_RALT), KC_DEL, KC_ENT
  ),
  [_NAV] = LAYOUT(
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,
     _______, LGUI(KC_LEFT), LGUI(KC_UP), LGUI(KC_DOWN), LGUI(KC_RGHT),_______,       LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_UP), LCTL(KC_RGHT), TG(_NUM),
     _______, KC_LGUI,   KC_LALT, KC_LCTL, KC_LSFT, _______,                          KC_LEFT,  KC_DOWN, KC_UP, KC_RGHT, KC_CAPS, KC_NO,
     _______,  _______,  _______, _______, _______, _______,                          KC_HOME,  KC_PGDN, KC_PGUP, KC_END, KC_INS, KC_TRNS,
     RESET, KC_TRNS, KC_TRNS,                     KC_TRNS,                            KC_DEL,          KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [_SYM] = LAYOUT(
    KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU,
    _______, KC_LCBR,  KC_AMPR,    KC_ASTR,   KC_LPRN,   KC_RCBR,     KC_NO,          KC_UNDS,      KC_EXLM,        KC_NO, KC_PERC, KC_TRNS,
    _______, KC_COLN,  KC_DLR,     KC_PERC,   KC_CIRC,   KC_EQL,     KC_HASH,S(A(C(KC_TAB))), C(A(KC_TAB)),      KC_PIPE, KC_SCLN, KC_TRNS,
    XXXXXXX, KC_TILD,  KC_EXLM,    KC_AT,     KC_HASH,   KC_BSLS,    G(C(KC_TAB)), G(KC_TAB),C(G(KC_LEFT)),C(G(KC_RGHT)), KC_BSLS, KC_TRNS,
    KC_TRNS,KC_LPRN, KC_RPRN,     KC_MINS,                               KC_TRNS,                    KC_MRWD, KC_MPLY, KC_MFFD
  ),
  [_NUM] = LAYOUT(
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,
    _______, KC_LBRC,  KC_7,     KC_8,    KC_9,    KC_MINS,       KC_LBRC, KC_F7, KC_F8, KC_F9, KC_RBRC, KC_TRNS,
    XXXXXXX, KC_PAST,  KC_4,     KC_5,    KC_6,    KC_PPLS,       KC_TRNS, KC_F4, KC_F5, KC_F6, KC_TRNS, KC_TRNS,
    XXXXXXX, KC_PSLS,  KC_1,     KC_2,    KC_3,    KC_BSLS,       KC_TRNS, KC_F1, KC_F2, KC_F3,  KC_F11,  KC_F12,
